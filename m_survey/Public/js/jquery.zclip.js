        ...
        if (typeof params == "object" && !params.length) {
            ...
            return this.each(function () {
                ...
                if (o.is(':visible') && (typeof settings.copy == 'string' || jQuery.isFunction(settings.copy))) {
                    ...
                    if (jQuery.isFunction(settings.copy)) {
                        o.on('zClip_copy', settings.copy);
                    }

                    if (jQuery.isFunction(settings.beforeCopy)) {
                        o.on('zClip_beforeCopy', settings.beforeCopy);
                    }

                    if (jQuery.isFunction(settings.afterCopy)) {
                        o.on('zClip_afterCopy', settings.afterCopy);
                    }
                    ...
                    jQuery(window).on('load resize', function () {clip.reposition();});
            ...
            return this.each(function () {
                ...
                if (params == "remove") {
                    ...
                    o.off('zClip_copy');
                    o.off('zClip_beforeCopy');
                    o.off('zClip_afterCopy');
